...
public class HYSB_Ex03 {
	...
	public static void main(String[] args) {
         ...
         if (updown.equals("UP")) {
        	 Collections.sort(valueList, (o1,o2)->(map.get(o1).compareTo(map.get(o2))));
             //[문제1] 오름차순으로 정렬되도록 해라.
             for (Integer key :valueList) { //오름차순 출력
                 System.out.println("value;"+map.get(key)+"CM");
             }
        	 ...
        	 Collections.sort(valueList, (o1,o2)->(map.get(o2).compareTo(map.get(o1))));
             //[문제2] 내림차순으로 정렬되도록 해라.
             for (Integer key :valueList) { //내림차순 출력
                 System.out.println("value;"+map.get(key)+"CM");
             }
             //[문제3] 한 번 실행되면 멈추도록 해라.
         } else {
