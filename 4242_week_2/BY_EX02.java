...
public class BY_EX02 {
	    public static void main(String[] args) {
            ...
            System.out.println("인덱스에 넣을 숫자를 입력해주세요:");
            for(int i=0; i<N; i++) {
            ...
            for(int i=0; i<N-1; i++ ){//배열의 i번째 숫자와 i+1번째 숫자를 비교하여 가장 큰 숫자가 마지막 순서로 이동할 수 있도록 하는 부분입니다.
	            //N-1인 이유는 마지막 순서에서는 이미 가장 큰 값이 정렬되어 있기 때문이다.
            	
	        	for(int j=0; j<N-1-i; j++ ){ //배열의 j번째 숫자와 j+1번째 숫자를 비교하여 가장 큰 숫자가 마지막 순서로 이동할 수 있도록 0하는 부분입니다.
	        ...
	        System.out.println("오름차순 정렬이 적용된 배열은 ");
